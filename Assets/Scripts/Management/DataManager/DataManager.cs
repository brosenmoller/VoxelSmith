...
public class DataManager : Manager
{
    ...
    private void LoadUpApplication()
    {
        ...
        paletteDataHolder.Data.palletePrefabs.Add(new VoxelPrefab() { color = Color.Color8(100, 200, 0), unityPrefabID = "67ce479430c155e4cbcd3bb0ef4f4954", prefabName = "TestSpehere" });
